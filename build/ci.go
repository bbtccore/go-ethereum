...
func doDockerBuildx(cmdline []string) {
	var (
		...
		hubImage = flag.String("hub", "ferrox/client-go", `Where to upload the docker image`)
	...
	//  - ferrox/client-go:latest                            - Pushes to the master branch, Geth only
	//  - ferrox/client-go:stable                            - Version tag publish on GitHub, Geth only
	//  - ferrox/client-go:alltools-latest                   - Pushes to the master branch, Geth & tools
	//  - ferrox/client-go:alltools-stable                   - Version tag publish on GitHub, Geth & tools
	//  - ferrox/client-go:release-<major>.<minor>           - Version tag publish on GitHub, Geth only
	//  - ferrox/client-go:alltools-release-<major>.<minor>  - Version tag publish on GitHub, Geth & tools
	//  - ferrox/client-go:v<major>.<minor>.<patch>          - Version tag publish on GitHub, Geth only
	//  - ferrox/client-go:alltools-v<major>.<minor>.<patch> - Version tag publish on GitHub, Geth & tools
	var tags []string
