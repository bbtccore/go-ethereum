...
var (
	MainnetGenesisHash = common.HexToHash("0xd24ea5b6f9727266b80236475c808ae297826cc50646c0cc1360d7c1b6109527")
...
var (
	...
	// MainnetChainConfig is the chain parameters to run a node on the FERROX main network.
	MainnetChainConfig = &ChainConfig{
		ChainID:                 big.NewInt(880880),
		...
		DepositContractAddress:  common.HexToAddress("0xfefefefefefefefefefefefefefefefefefefefe"),
...
var (
	...
	// DefaultBlobSchedule is the latest configured blob schedule for FERROX Mainnet.
...
var NetworkNames = map[string]string{
	MainnetChainConfig.ChainID.String(): FerroxMainnetName,
